# -*- coding:utf8 -*-
# demo version: 1.0, LB score: 0.676
#
...
# most `xxx_Identifier`s are probably categorical variable;
...
for fold_, (trn_idx, val_idx) in enumerate(folds.split(df_train.values, target.values)):
    ...
    predictions += clf.predict(df_test[features], num_iteration=clf.best_iteration) / min(folds.n_splits, max_iter)
...
print(sub_df[:10])
sub_df.to_csv('submission_base_demo.csv', index=False)
